...
@section('judul_halaman', 'Upload Proposal Sekertaris Direktur')
...
@section('konten')
    ...
    <div>
        ...
        <div class="col">
            <form class="card" action="{{ route('sekdir.update', $ID->ID) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                    ...
                    <div class="form-group form-floating">
                        <div class="row col-12">
                            <div class=" col-12" style="margin-bottom: 12px">
                                ...
                                <input type="file" maxlength="12" name="proposal"
                            ...
                            <input type="hidden" maxlength="12" name="isSekdirAcc" class="form-control"
                                value="1">
