                        ...
                        <div class="card-body col-12">
                            ...
                            <div class="row" >
                                ...
                                <div class=" col-12" style="margin-bottom: 12px">
                                    ...
                                    <input type="text" maxlength="12" name="penyerapan_dana" class="form-control" placeholder="Masukkan Nama Kompetisi . . . .">
                                </div>
                                <div class=" col-12" style="margin-bottom: 12px">
                                    <label for="">Sertifikat</label>
                                    <input type="file" maxlength="12" name="sertifikat" class="form-control" placeholder="Masukkan Nama Kompetisi . . . .">
