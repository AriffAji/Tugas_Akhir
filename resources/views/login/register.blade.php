                ...
                <div class="row justify-content-center">
                                    ...
                                    <div class="shadow p-3 mb-5 bg-body " style="border-radius:5px">
                                        <div class="form-group form-floating">
                                            ...
                                            <input id="username" type="text"
                                                ...
                                                name="username" placeholder="Nama Anda" value="{{ old('username') }}"
                                                required>
                                            @error('username')
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group ">
                                                ...
                                                <input id="nim" type="number"
                                                    ...
                                                    name="nim" placeholder="361955401112"
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <input id="email" type="email"
                                                    ...
                                                    name="email" placeholder="none@gmail.com"
                    ...
                    <div class="form-group ">
                            ...
                            <input id="prodi" type="text" class="form-control" name="prodi" autofocus>
                                ...
                                <div class="mt-5 text-muted text-center shadow p-3 mb-5 bg-body "
