                    ...
                    <table class="table table table-hover" id="table-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{$nm->peran}}</td>
                                <td class="text-center text-nonwrap">
                                    <a href="{{ route('edit.user',$nm->id) }}" class="btn btn-primary btn-action mr-1 "><i class="fas fa-pencil-alt"></i></a>
                                    <a href="{{ route('hapus.user',$nm->id) }}"  class="btn btn-danger btn-action mr-1" method="POST" onclick="return confirm('yakin?');"> 
                                        @csrf
                                        @method('delete')
